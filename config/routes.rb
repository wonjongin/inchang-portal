Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get 'vacations/list'
      get 'vacations/detail/:vacation_id', to: 'vacations#detail'
      get 'vacations/new'
      ...
      get 'car_log/xlsx_form/:car_id', to: 'car_log#xlsx_form'
      get 'car_log/xlsx_log/:car_id/:start/:end', to: 'car_log#xlsx_log'
